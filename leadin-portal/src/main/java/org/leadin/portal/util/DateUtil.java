...
public class DateUtil {
    ...
    private static final String FORMAT_00 = "yyyy-MM-dd HH:mm";
    ...
    public static Date reverse2Date(String date) {
        ...
        switch (date.trim().length()) {
            case 19:// 日期+时间
                ...
                break;
            case 16:// 日期+时间00:00
                simple = new SimpleDateFormat(FORMAT_00);
                break;
            case 10:// 仅日期
    ...
    public static void main(String[] args) {
        ...
        System.err.println(getStartTimeOfDate(new Date()));
        System.err.println(getEndTimeOfDate(new Date()));
    }
