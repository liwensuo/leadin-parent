...
public class LogUtil {
    private static final Logger logger = LoggerFactory.getLogger("LEADIN");
    ...
    private static final String PACKAGE_FLAG = "cn.";
        ...
        for (StackTraceElement ste : stack) {
            if ((ste.getClassName().indexOf("LogUtil")) == -1 && ste.getClassName().indexOf("Thread") == -1) {
                ...
                try {
                    ...
                    if(actionClass.getName().contains("cn..common")){//common底下放入service范围
